...
AngelListConnector.prototype.get = function (url, queryParams, data) {
...
AngelListConnector.prototype.delete = function (url, data) {
...
AngelListConnector.prototype.request = function (method, path, queryParams, data) {
  ...
  if (data && data.body && method === 'PUT' || method === 'POST') {
